    ...
    *,
    ...
    try:
        ...
        inputs = GUIBuildInputs(
            ...
            split_strategy=SplitStrategy(values["split_strategy"]),
            ...
            validation_start_date=values["validation_start_date"],
            validation_end_date=values["validation_end_date"],
            test_start_date=values["test_start_date"],
            test_end_date=values["test_end_date"],
            custom_split_column=values["custom_split_column"],
