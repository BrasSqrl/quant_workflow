...
def gui_inputs_from_framework_config(config: FrameworkConfig) -> GUIBuildInputs:
    ...
    return GUIBuildInputs(
        ...
        split_strategy=config.split.split_strategy,
        ...
        train_start_date=config.split.train_start_date or "",
        train_end_date=config.split.train_end_date or "",
        validation_start_date=config.split.validation_start_date or "",
        validation_end_date=config.split.validation_end_date or "",
        test_start_date=config.split.test_start_date or "",
        test_end_date=config.split.test_end_date or "",
        custom_split_column=config.split.custom_split_column or "",
